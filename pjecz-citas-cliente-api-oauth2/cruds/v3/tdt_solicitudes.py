...
from ...dependencies.safe_string import safe_integer, safe_string
from ...models.cit_clientes import CitCliente
from ...models.tdt_solicitudes import TdtSolicitud
from ...schemas.v3.tdt_solicitudes import TdtSolicitudIn, TdtSolicitudOut
from ...settings import CLOUD_STORAGE_DEPOSITO
from .cit_clientes import create_cit_cliente, get_cit_cliente
from .municipios import get_municipio_from_id_hasheado
from .tdt_partidos import get_tdt_partido_from_siglas
